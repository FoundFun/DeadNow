...
namespace BasicTemplate.CodeBase
{
    public class GameRoot : MonoBehaviour
    {
        ...
        [SerializeField] private YandexBackgroundChanger _yandexBackgroundChanger;
        ...
        private void Awake()
        {
            ...
            _leaderBoardService =
                new YandexLeaderBoardService(_leaderBoardView, _authorizationView);
            ...
            _yandexBackgroundChanger.Construct(soundService);
